...

               {
                  !group?.qualificationLocked ? (
                     ...
                     <div className="flex items-center gap-4">
                        ...
                        <div className="rounded-2xl border border-green-500/20 bg-green-500/10 px-5 py-4 font-bold text-green-300">
                        ...
                        <button
                           ...
                           className="rounded-2xl border border-red-500/20 bg-red-500/10 px-5 py-4 font-bold text-red-300 transition hover:bg-red-500/20"
                        >
                                       ...
                                       >
                                          ...
                                          <td className="px-6 py-5">
                                             ...
                                             <div>
                                                ...
                                                <Link
                                                   href={`/admin/teams/${item.team._id}?from=group&groupId=${group._id}`}
                                                   target="_blank"
